...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_path', type=str, default="samples/inputs/kuma.png", help='Path to the input image.')
    parser.add_argument('--mask_path', type=str, default="samples/inputs/kuma_mask.png", help='Path to the mask image.')
    parser.add_argument('--bg_path', type=str, default="samples/inputs/canyon.png", help='Path to the background image.')
    parser.add_argument('--output_dir', type=str, default="samples/outputs/HRNet/Canyon_kuma", help='Directory to save output images.')
    parser.add_argument('--name', type=str, default="camouflage", help='Name of the output image.')
    ...
    parser.add_argument('--crop', type=bool, default=True, help='Whether to crop the mask or not.')
    ...
    # Logging settings
    parser.add_argument('--show_every', type=int, default=10, help='How often to display intermediate results.')
